...
FIX = [
    ...
    ("3.14", "Sona", "力量和絃", "新增：Staccato",
     "力量和絃｜新增：斷奏（Staccato）具有（+20% AP）加成。"),
    ("3.14", "Sona", "力量和絃", "新增：Diminuendo",
     "力量和絃｜新增：漸弱（Diminuendo）具有（每 100 AP +2%）加成。"),
    ("3.14", "Sona", "力量和絃", "新增：Tempo",
     "力量和絃｜新增：節拍（Tempo）具有（每 100 AP +4%）加成。"),
    ("3.8", "Sona", "力量和絃", "Diminuendo 持續時間",
     "力量和絃｜漸弱（Diminuendo）持續時間：4 ⇒ 3 秒"),
    ...
    ("3.7", "Zyra", "荊棘鞭笞", "新增：Thorn Spitter 與 Vine Lasher",
     "荊棘鞭笞｜新增：荊棘吐刺者（Thorn Spitter）與藤蔓鞭笞者（Vine Lasher）"
     "可受指揮旗幟的軍團效果加成。"),
