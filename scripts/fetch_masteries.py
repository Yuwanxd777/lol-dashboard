...
# 2013 的 DDragon 資產已下架（4.2.6 以前全部 403）→ 用最早拿得到的 4.2.6 當代理版本。
# 注意 S4 季前（2013-11 的 3.14）就大改過天賦，所以這是「最接近」而非「當年原貌」。
VERS = {2013: ["4.2.6"], 2014: ["4.16.1", "4.21.5"], 2015: ["5.16.1", "5.24.2"], 2016: ["6.16.2", "6.24.1"], 2017: ["7.16.1", "7.21.1"]}
...
def main():
    ...
    TREE_VERS = {2013: "4.2.6", 2014: "4.16.1", 2015: "5.16.1", 2016: "6.16.2", 2017: "7.16.1"}
    trees_out = {}
